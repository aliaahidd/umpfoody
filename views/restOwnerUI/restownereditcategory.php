...
<head>
    ...
    <title>Foody | Restaurant Owner Edit Category </title>
    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                <div class="page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="restownermenu.php">Category</a></li>
                            ...
                            <div class="profile-head">
                                ...
                                <div class="profile-info" style="display: block;">
                                    ...
                                    <div class="basic-form">
                                        <?php
                                        $queryCategory = "SELECT * FROM menucategory where categoryID = $categoryID ";
                                        $resultCategory = mysqli_query($con, $queryCategory);
                                        while ($row = mysqli_fetch_array($resultCategory)) {
                                        ?>
                                            <form method= "POST" action="queryedit.php?id=<?php echo $categoryID ?>" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Category Name</label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" value="<?php echo $row["categoryName"]; ?>" name="categoryName">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Category Photo</label>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div id="box">
                                                        <center>
                                                            <div id=""><br><?php echo '<img src="data:image;base64,' . base64_encode($row['categoryPhoto']) . '" id="display" style="width: 200px; height: 200px;">' ?>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-10">
                                                        <button type="submit" class="btn btn-primary btn-sm" name="editCategory">Update</button>
                                                    </div>
                                                </div>
                                            </form>
                                        <?php } ?>
