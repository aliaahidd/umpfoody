...
<head>
    ...
    <title>Foody | Restaurant Owner Profile </title>
    <!-- Favicon icon -->
                ...
                <div class="row">
                    <div class="col-xl-6 offset-xl-6">
                        <div style="float: right; margin-bottom: 10px;">
                            <button class="btn btn-primary btn-sm" onclick="location.href='restownernewcategory.php'">+ New Category</button>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <?php
                    $queryCategory = "SELECT * FROM menucategory mc inner join restaurantdetails rd on mc.restaurantID = rd.restaurantID where rd.userloginID = '" . $_SESSION['userloginID'] . "'";
                            ...
                            <div class="card">
                                <div class="dropdown ml-auto" style="padding: 10px;">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <a href="restownereditcategory.php?id=<?php echo $categoryID ?>" name="editCategory">
                                            <li class="dropdown-item"><i class="flaticon-381-edit"></i></i> Edit </li>
                                        </a>
                                        <a href="querydeletecategory.php?id=<?php echo $categoryID ?>" id="delete" name="deleteCategory">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="new-arrival-product">
                                        <div class="new-arrivals-img-contnent">
                                            <?php if ($row['categoryPhoto'] != "") { ?>
                                                <center><?php echo '<img src="data:image;base64,' . base64_encode($row['categoryPhoto']) . '" id="display" style="width: 100px; height: 100px; border-radius: 50%;"> ' ?></center>
                                            <?php } else { ?><center><img src="profImage/anon.png" id="profImg" style="width: 100px; height: 100px;"> </center>

                                            <?php } ?>
                                        </div>
                                        <div class="new-arrival-content text-center mt-3">
                                            <h4><a href="ecom-product-detail.html"><?php echo $categoryname; ?></a></h4>
                                            <?php
                                            $querytotalmenu = "SELECT * FROM menulist where categoryID = $categoryID";
                                            $resulttotalmenu = mysqli_query($con, $querytotalmenu);
                                            ?>
                                            <a href="menulist.php?id=<?php echo $row['categoryID']; ?>"><span class="price"><?php echo mysqli_num_rows($resulttotalmenu) ?> items</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
