                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example4" class="display min-w850">
                                        ...
                                        <tbody>
                                            <?php
                                            $queryorderlist = "SELECT * FROM orderlist where restaurantID = '" . $_SESSION['restaurantID'] . "'  order by orderID DESC";
                                            $resultOrderlist = mysqli_query($con, $queryorderlist);
                                            while ($row = mysqli_fetch_array($resultOrderlist)) {
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                        <button class="btn btn-warning btn-sm" onclick="location.href='querystatus.php?id=<?php echo $row['orderID'];?>'"><?php echo $row["orderStatus"]; ?></button> <?php } ?>
                                                        <?php 
                                                        if($row["orderStatus"] == "Prepared"){
                                                        ?>
                                                        <span class="badge light badge-secondary"><?php echo $row["orderStatus"]; ?></span> <?php } ?>
                                                        <?php 
                                                        if($row["orderStatus"] == "Out for delivery"){
                                                        ?>
                                                        <span class="badge light badge-info"><?php echo $row["orderStatus"]; ?></span> <?php } ?>
                                                        <?php 
                                                        if($row["orderStatus"] == "Delivered"){
                                                        ?>
                                                        <span class="badge light badge-success"><?php echo $row["orderStatus"]; ?></span> <?php } ?>
                                                        <?php 
                                                        if($row["orderStatus"] == "Cancelled"){
                                                        ?>
                                                        <span class="badge light badge-danger"><?php echo $row["orderStatus"]; ?></span> <?php } ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
