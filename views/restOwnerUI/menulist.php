            ...
            <div class="container-fluid">
                <div class="page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="restownermenu.php">Menu</a></li>
                ...
                <div class="row">
                    <div class="col-xl-6 offset-xl-6">
                        <div style="float: right; margin-bottom: 10px;">
                            <button class="btn btn-primary btn-sm" onclick="location.href='restownernewmenu.php?id=<?php echo $categoryID?>'">+ New Menu</button>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <?php
                    $queryCategory = "SELECT * FROM menulist ml inner join restaurantdetails rd on ml.restaurantID = rd.restaurantID inner join 
                    menuCategory mc on mc.categoryID = ml.categoryID where rd.userloginID = '" . $_SESSION['userloginID'] . "' and ml.categoryID = $categoryID";
                    ...
                    ?>
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                            <div class="card">
                                <div class="dropdown ml-auto" style="padding: 10px;">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <a href="restownereditmenu.php?id=<?php echo $menuID ?>&mc=<?php echo $categoryID ?>" name="editMenu">
                                            <li class="dropdown-item"><i class="flaticon-381-edit"></i></i> Edit </li>
                                        </a>
                                        <a href="querydeletemenu.php?id=<?php echo $menuID ?>&mc=<?php echo $categoryID ?>" id="delete" name="deleteMenu">
                                            <li class="dropdown-item" style="color: red;"><i class="flaticon-381-trash-1"></i></i> Delete </li>
                                        </a>
                                    </ul>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="new-arrival-product">
                                        <div class="new-arrivals-img-contnent">
                                            <?php if ($row['menuPhoto'] != "") { ?>
                                                <center><?php echo '<img src="data:image;base64,' . base64_encode($row['menuPhoto']) . '" id="display" style="width: 100px; height: 100px; border-radius: 50%;"> ' ?></center>
                                            <?php } else { ?><center><img src="profImage/anon.png" id="profImg" style="width: 100px; height: 100px;"> </center>

                                            <?php } ?>
                                        </div>
                                        <div class="new-arrival-content text-center mt-3">
                                            <h4><a href="ecom-product-detail.html"><?php echo $menuName; ?></a></h4>
                                            <h4><?php echo $row['menuQuantityAvail']; ?></a></h4>
                                            <span class="price">RM <?php echo $row['menuPrice']; ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
