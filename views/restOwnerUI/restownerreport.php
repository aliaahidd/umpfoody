...
if (isset($_POST["searchSubmit"])) {
    ...
    $querysearchreport = "SELECT * FROM orderlist where (OrderDate BETWEEN '$fromDate' and '$toDate') && (restaurantID='$restaurantID') group by OrderDate";
    $resultsearchreport = mysqli_query($con, $querysearchreport) or die(mysqli_error($con));
    $countSearch = mysqli_num_rows($resultsearchreport);
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="restownerhome.php">Dashboard</a></li>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="restownerreport.php">
                                    <div class="row">
                                        <div class="col-3">
                                            <p class="mb-1">Start Date</p>
                                            <input type="date" name="datepicker1" class="form-control" id="datepicker">
                                        </div>
                                        <div class="col-3">
                                            <p class="mb-1">End Date</p>
                                            <input type="date" name="datepicker2" class="form-control" id="datepicker">
                                        </div>
                                        <div class="col-3">
                                            <p class="mb-1">.</p>
                                            <input type="submit" name="searchSubmit" class="btn btn-primary">
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 offset-xl-6">
                            <div style="float: right; margin-bottom: 10px;">
                                <button class="btn btn-primary btn-sm" name="exportOverall" onclick="location.href='exportData.php?id=<?php echo $_SESSION['restaurantID'] ?>&fd=<?php echo $fromDate ?>&td=<?php echo $toDate ?>'">Export Data</button>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <h4 class="card-title">Order List From <?php echo $fromDate ?> to <?php echo $toDate ?></h4>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example4" class="display min-w600">
                                            <thead>
                                                <tr>
                                                    <th>Order ID</th>
                                                    <th>Name</th>
                                            ...
                                            <tbody>
                                                ...
                                                if (mysqli_num_rows($resultsearchreport) > 0) {
                                                    while ($row = mysqli_fetch_array($resultsearchreport)) {
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row["OrderDate"]; ?>, <?php echo date('l', strtotime($row['OrderDate'])); ?></td>
                                                            <td>RM<?php echo $row["amountPaid"]; ?></td>

                                                            <td></td>
                                                            <td style="text-align: center;"><?php echo $countSearch ?></td>
                                                        </tr>
                                                <?php }
                                                } ?>
                                            </tbody>
                ...
                <!-- <div class="row">
                    <div class="col-6">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Order List For last 7 days</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example4" class="display min-w600">
                                        ...
                                        <tbody>
                                            ...
                                            $queryWeekday = "SELECT DISTINCT OrderDate, month(OrderDate), day(OrderDate), year(OrderDate) FROM orderlist WHERE OrderDate BETWEEN DATE_SUB( CURDATE( ), INTERVAL 7 DAY ) AND CURDATE( )";
                                            ...
                                            ?>
                                                    <tr>
                                                        <td><?php echo $dateDay . '/' . $dateMonth . '/' . $dateYear ?></td>
                                                        <td><?php echo $dateFullName ?></td>
                                                        <td style="text-align: center;"><?php echo $countOrderListDay ?></td>
                                                    </tr>
                                            <?php }
                                            } ?>
                                        </tbody>
                    ...
                    <div class="col-6">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Order List For <?php echo date('F, Y'); ?></h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example4" class="display min-w600">
                                        ...
                                        <tbody>
                                            ...
                                            $monthDate = date('m');
                                            $yearDate = date('Y');
                                            $queryMonth = "SELECT DISTINCT OrderDate, month(OrderDate), day(OrderDate), year(OrderDate) FROM orderlist WHERE month(OrderDate) = $monthDate and year(OrderDate) = $yearDate order by day(OrderDate) desc";
                                            ...
                                            ?>
                                                    <tr>
                                                        <td><?php echo $dateDay . '/' . $dateMonth . '/' . $dateYear ?></td>
                                                        <td><?php echo $dateFullName ?></td>
                                                        <td style="text-align: center;"><?php echo $countOrderListDay1 ?></td>
                                                    </tr>
                                            <?php }
                                            } ?>
                                        </tbody>
