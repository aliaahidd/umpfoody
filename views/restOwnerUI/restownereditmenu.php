...
<head>
    ...
    <title>Foody | Restaurant Owner Edit Menu </title>
    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                <div class="page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="menulist.php">Menu</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-primary">Edit Menu</h2>
                            ...
                            <div class="profile-head">
                                ...
                                <div class="profile-info" style="display: block;">
                                    ...
                                    <div class="basic-form">
                                        <?php
                                        $queryCategory = "SELECT * FROM menulist where menuID = $menuID ";
                                        $resultCategory = mysqli_query($con, $queryCategory);
                                        while ($row = mysqli_fetch_array($resultCategory)) {
                                        ?>
                                            <form method= "POST" action="queryedit.php?id=<?php echo $menuID ?>&mc=<?php echo $categoryID?>" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Menu Name</label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" value="<?php echo $row["menuName"]; ?>" name="menuName">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Menu Price</label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" value="<?php echo $row["menuPrice"]; ?>" name="menuPrice">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Menu Quantity</label>
                                                    <div class="col-lg-6">
                                                        <input type="number" class="form-control" value="<?php echo $row["menuQuantityAvail"]; ?>" name="menuQty">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Menu Photo</label>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Image Preview</label>
                                                    <div id="box">
                                                        <center>
                                                            <div id=""><br><?php echo '<img src="data:image;base64,' . base64_encode($row['menuPhoto']) . '" id="display" style="width: 200px; height: 200px;">' ?>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-10">
                                                        <button type="submit" class="btn btn-primary btn-sm" name="editMenu">Update</button>
                                                    </div>
                                                </div>
                                            </form>
                                        <?php } ?>
