...
<head>
    ...
    <title>Foody | Restaurant Owner New Category </title>
    <!-- Favicon icon -->
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-primary">Menu - New Category</h2>
                            ...
                            <div class="profile-head">
                                ...
                                <div class="profile-info" style="display: block;">
                                    ...
                                    <div class="basic-form">
                                        <form method="post" action="queryinsert.php" enctype="multipart/form-data">
                                            <div class="form-group row">
                                                <label class="col-lg-2 col-form-label">Name</label>
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" placeholder="Ex: Pasta" name="categoryName">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                            <label class="col-lg-2 col-form-label">Iamge Preview</label>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-10">
                                                    <button type="submit" class="btn btn-primary btn-sm" name="newCategory">Add New Category</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
