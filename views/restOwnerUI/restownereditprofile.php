...
<head>
    ...
    <title>Foody | Restaurant Owner Edit Profile </title>
    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                <div class="page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="restownerprofile.php">Profile</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-primary">Restaurant - Edit Profile</h2>
                                    ...
                                    <div class="basic-form">
                                        ...
                                        <form>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" value="<?php echo $row["restaurantName"]; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-2 col-form-label">Contact Number</label>
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" value="<?php echo $row["restaurantContactNo"]; ?>">
                                                </div>
                                            </div>
                                            <fieldset class="form-group">
                                                <div class="row">
                                                    <label class="col-form-label col-lg-2 pt-0">Campus</label>
                                                    <div class="col-lg-6">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="restCampus" value="option1" checked>
                                                            <label class="form-check-label">
                                                                Gambang
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="restCampus" value="option2">
                                                            <label class="form-check-label">
                                                                Pekan
                                                            </label>
                                                        </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-2">Time Operation</div>
                                                <div class="col-lg-6">
                                                    <div class="form-check">
