...
<head>
    ...
    <title>Foody | Restaurant Owner New Menu </title>
    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                <div class="page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="menulist.php?id=<?php echo $categoryID ?>">Menu</a></li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">New Menu</a></li>
                    </ol>
                </div>

                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-primary">Menu - New Menu</h2>
                            ...
                            <div class="profile-head">
                                ...
                                <div class="profile-info" style="display: block;">
                                    ...
                                    <div class="basic-form">
                                        <form method="post" action="queryinsert.php?id=<?php echo $categoryID; ?>" enctype="multipart/form-data">
                                            <div class="form-group row">
                                                <label class="col-lg-2 col-form-label">Name</label>
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" placeholder="Ex: Nasi Goreng" name="menuName">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-2 col-form-label">Price</label>
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" placeholder="Ex: 10.90" name="menuPrice" pattern="^[1-9][0-9]*(\.[0-9]{1,2})?$">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-2 col-form-label">Quantity</label>
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" placeholder="Ex: 3" name="menuQty">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-2 col-form-label">Description</label>
                                                <div class="col-lg-6">
                                                    <textarea class="form-control" placeholder="Ex: Nasi Goreng with fried egg" name="menuDescription" rows="6" cols="50"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <label class="col-lg-2 col-form-label">Image Preview</label>
                                                <div id="box" class="col-lg-6">
                                                    <div id=""><br><img id="display" src="profImage/no-image.png" style="width: 200px; height: 200px">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-10">
                                                    <button type="submit" class="btn btn-primary btn-sm" name="newMenu">Add New Menu</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
