        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-primary">Restaurant Profile</h2>
                                ...
                                <div class="profile-info">
                                    ...
                                    <div class="profile-details">
                                        <div class="profile-name px-3 pt-2">
                                            <h4 class="text-muted mb-0"> Name</h4><br>
                                            <h4 class="text-muted mb-0"> Contact Number</h4><br>
                                            <h4 class="text-muted mb-0"> Address</h4><br>
                                            <h4 class="text-muted mb-0"> Time Operation</h4><br>
                                        </div>
                                        <div class="profile-email px-2 pt-2" style="margin-left: 100px;">
                                            <?php
                                            $queryRestDetails = "SELECT * FROM restaurantdetails where userloginID = '" . $_SESSION['userloginID'] . "'";
                                            $resultRestDetails = mysqli_query($con, $queryRestDetails);
                                            while ($row = mysqli_fetch_array($resultRestDetails)) {
                                            ?>
                                                <h4 class="text-muted mb-0"><?php echo $row["restaurantName"]; ?></h4><br>
                                                <h4 class="text-muted mb-0"><?php echo $row["restaurantContactNo"]; ?></h4><br>
                                                <h4 class="text-muted mb-0"><?php echo $row["restaurantLocation"]; ?></h4><br>
                                                <h4 class="text-muted mb-0"><?php echo $row["restaurantTimeOperation"]; ?></h4>
                                            <?php } ?>
                                        </div>
                                        <div class="dropdown ml-auto">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <a href="restownereditprofile.php"><li class="dropdown-item"><i class="fa fa-user-circle text-primary mr-2"></i> Edit profile</li></a>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
